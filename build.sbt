...
libraryDependencies += "com.github.emptyflash" % "hbc" % "hbc-2.2.3"
libraryDependencies += "com.github.emptyflash.hbc" % "hbc-twitter4j" % "hbc-2.2.3"
libraryDependencies += "com.github.emptyflash.hbc" % "hbc-core" % "hbc-2.2.3"
